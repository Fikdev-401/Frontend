...
import 'package:flutter_frontend/ui/dialogs/edit_journal_dialogs.dart';
...
class _DetailJournalPageState extends State<DetailJournalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<DeleteJournalBloc, JournalsState>(
      listener: (context, state) {
        if (state is DeleteJournalSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Journal berhasil dihapus')),
          );
          Navigator.pop(context);
          context.read<JournalsBloc>().add(LoadJournals(userId: userId));
        } else if (state is DeleteJournalError) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Gagal menghapus journal')),
          );
        }
      },
      child: Scaffold(
                  ...
                  children: [
                    _buildSpotifyButton(
                      ...
                      onTap: () {
                        showDialog(
                          context: context,
                          builder: (context) => EditJournalDialogs(
                            journalId: widget.id,
                            categoryId: widget.categoryId,
                            categoryTitle: widget.categoryTitle,
                            journalTitle: widget.title,
                            journalDesc: widget.desc,
                          ),
                        );
                      },
                    ),
  ...
  showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: ()  {
            context.read<DeleteJournalBloc>().add(DeleteJournal(id: id));
