...
class _AddJournalPageState extends State<AddJournalPage> {
  ...
  void _saveJournal() {
    ...
    final requestBody = AddJournalRequestModel(
      title: _titleController.text,
      desc: _descController.text,
      categoryJournalId: _selectedCategoryId,
    );
                ...
                builder: (context, state) {
                  if (state is CategoryJournalLoading)
                    ...
                    return ListView.builder(
                      itemCount: state.categoryJournal.length,
                      itemBuilder: (context, index) {
                        final category = state.categoryJournal[index];
                        return ListTile(
                          title: Text(
                            category.title,
